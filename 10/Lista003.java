...
public class Lista003 extends LinearList implements LinearListInterface {
    ...
    @Override
    public boolean equalsList(LinearListInterface listEntrada) {
        Lista003 list = (Lista003) listEntrada;
        if (list == null)
            return false;
        ...
        // se ambos chegaram ao fim, são iguais
        return a == null && b == null;
    }

    @Override
    public Lista003[] divide() {
        Lista003 pares = new Lista003();
        Lista003 impares = new Lista003();
        ...
        while (curr != null) {
            ...
            if (v % 2 == 0) {
                pares.append(new Node<>(v));
            } else {
                impares.append(new Node<>(v));
            }
            curr = curr.getNext();
        }

        return new Lista003[] { pares, impares };
    }
